...
public class WebEventListener extends BaseAPI implements WebDriverEventListener {
    ...
    public void afterFindBy(By by, WebElement webElement, WebDriver webDriver) {
        System.out.println("SUCCESSFULLY FOUND " + webElement);
    }

    @Override
    public void beforeClickOn(WebElement webElement, WebDriver webDriver) {
        System.out.println("ATTEMPTING TO CLICK " + webElement);
    }

    @Override
    public void afterClickOn(WebElement webElement, WebDriver webDriver) {
        System.out.println("SUCCESSFULLY CLICKED " + webElement);
    }
    ...
    public void beforeSwitchToWindow(String s, WebDriver webDriver) {
        System.out.println("ATTEMPTING TO SWITCH TO A NEW WINDOW " + s);
    }
    ...
    public void afterGetText(WebElement webElement, WebDriver webDriver, String s) {
        System.out.println("SUCCESSFULLY RETRIEVED TEXT FROM " + webElement);
    }
}
